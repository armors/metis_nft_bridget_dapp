        ...
        <div class="modal-container" :class="list.length !== 0 ? 'mt1100px' : ''">
          ...
          <div class="modal-footer display-flex box-center-Y fs30 fw4">
            <slot name="footer">
              ...
              <div class="box-flex1" v-show="cancelBtn"></div>
              <y-btn class="modal-primary-button" :class="['primary', cancelBtn ? '' : 'all-width']" @submitAction="confirm">
...
<style lang="less" scoped>
  ...
  .modal-footer{
    ...
    .modal-primary-button.all-width {
      margin: 0 auto;
    }
  }
